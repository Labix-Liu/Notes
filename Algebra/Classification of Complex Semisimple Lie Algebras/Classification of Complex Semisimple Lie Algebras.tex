...
\fancyhf{}
\rhead{Labix}
\lhead{Classification of Complex Semisimple Lie Algebras}
\rfoot{\thepage}

\title{Classification of Complex Semisimple Lie Algebras}
...
\pagebreak
\section{Lie Algebras over a Field}
\subsection{Lie Subalgebras of the Matrix Ring}
\begin{prp}{}{}\\
Let $k$ be a field. Let $V$ be a Lie algebra over $k$. Choose a basis $\{e_1,\dots,e_n\}$ of $V$. Then the map $\mathfrak{gl}_n(V)\to\mathfrak{gl}_n(k)$ defined by $$T\mapsto\begin{pmatrix}&&\\
T(e_1) & \cdots & T(e_n)\\
&&
...
\subsection{Nilpotency and Engel's Theorem}
\begin{eg}{}{}\\
...
\begin{eg}{}{}\\
Let $n\in\N$ such that $n\geq 2$. Let $k$ be a field. Then $\mathfrak{u}_n(k)$ is nilpotent. 
\begin{proof}
...
\subsection{Solubility and Lie's Theorem}
...
\begin{lmm}{}{} \\Let $L$ be a Lie algebra of dimension $1$. Then $L$ is abelian. 
\begin{proof}
...
\begin{lmm}{}{}\\If $L$ is semisimple, then $\dim(L)\geq 3$. 
\begin{proof}
...
\subsection{Derivations of a Semisimple Lie Algebras over $\C$}
