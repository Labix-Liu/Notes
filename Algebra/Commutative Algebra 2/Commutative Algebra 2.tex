...
\subsection{Graded Injective and Projective Modules}
Let $R$ be a graded ring. Then the category of graded modules over $R$ is abelian. Therefore we may define graded injective and graded projective modules in the same way, as well as graded free, graded injective and graded projective resolutions. 

\begin{eg}{}{}\\
Let $k$ be a field. Let $R=k[x]$ with $\deg(x)=1$. Then $k[x,x^{-1}]/k[x]$ is an injective graded $R/xR$-module, but it is not injective as an ungraded module. 
\end{eg}

\begin{prp}{}{}\\
Let $R$ be a graded ring. Let $I$ be a graded $R$-module. Then $I$ is injective if and only if for graded $R$-modules $M,N$ and all injective graded homomorphisms $f:M\to N$ and all graded maps $u:M\to I$, there exists a graded morphism $N\to I$ such that the following diagram commutes: \\
\adjustbox{scale=1.0,center}{\begin{tikzcd}
	M & I \\
	N
...
\begin{lmm}{}{}\\
Let $R$ be a graded ring. Let $F$ be a graded free $R$-module. Then $F$ is projective. 
\end{lmm}

\begin{prp}{}{}\\
Let $R$ be a graded ring. Let $P$ be a graded $R$-module. Then the following are equivalent. 
\begin{itemize}
\item $P$ is projective. 
\item For all graded $R$-modules $M,N$ and all surjective graded homomorphisms $f:M\to N$ and graded $u:P\to N$, there exists a graded morphism $P\to M$ such that the following diagram commutes: \\
\adjustbox{scale=1.0,center}{\begin{tikzcd}
	& M \\
	P & N
...
\end{tikzcd}}\\
\item $P\oplus Q$ is a graded free $R$-module for some graded $R$-module $Q$. 
\end{itemize}
\end{prp}

\begin{prp}{}{}\\
Let $R$ be a graded ring. Let $P$ be a graded $R$-module that is projective. Then $P$ is projective as an ungraded $R$-module. 
\end{prp}
...
\begin{prp}{}{}\\
Let $R$ be a commutative ring. Let $S$ be a multiplicative subset of $R$. Then $S^{-1}R$ is a flat $R$-module. 
\end{prp}
...
\pagebreak
\section{Finiteness Properties of Modules}
...
In particular, since localization can be described as a tensor product: $S^{-1}M=S^{-1}R\otimes_RM$, we have a natural isomorphism $$\Hom_{S^{-1}R}(S^{-1}M,S^{-1}N)\cong S^{-1}\Hom_R(M,N)$$

\subsection{Coherent Modules}
\begin{defn}{Coherent Modules}{}\\
Let $R$ be a commutative ring. Let $M$ be an $R$-module. We say that $M$ is coherent if the following are true. 
\begin{itemize}
\item $M$ is finitely generated. 
\item For any $R$-module homomorphism $R^{\oplus n}\to M$, the kernel is finitely generated. 
\end{itemize}
\end{defn}
...
\begin{itemize}
\item If $M$ is finitely presented, then $M$ is finitely generated. 
\item If $M$ is coherent, then $M$ is finitely presented. 
\end{itemize}
\end{lmm}

\begin{lmm}{}{} Let $R$ be a Noetherian commutative ring. Let $M$ be an $R$-module. Then the following are equivalent. 
\begin{itemize}
\item $M$ is finitely generated. 
...
Then the following are true. 
\begin{itemize}
\item f $M_2$ is coherent and $M_1$ is finitely generated, then $M_1$ is finitely generated. 
\item If $M_2,M_3$ are coherent, then $M_1$ is coherent. 
\item If $M_1$ is finitely generated and $M_2$ is coherent, then $M_3$ is coherent. 
\item If $M_1,M_3$ are coherent, then $M_2$ is coherent. 
\end{itemize}
\end{prp}

\begin{lmm}{}{}\\
Let $R$ be a commutative ring. Let $M$ be a coherent $R$-modules. Let $N_1,N_2\leq M$ be coherent $R$-submodules of $M$. Then $N_1+N_2$ and $N_1\cap N_2$ are coherent. 
\end{lmm}

\begin{lmm}{}{}\\
Let $R$ be a commutative ring. Then $R$ is coherent if and only if every finitely presented $R$-module is coherent. 
\end{lmm}

\begin{defn}{The Category of Coherent Modules}{}\\
Let $R$ be a commutative ring. Define the category $\bold{Coh}_R$ of coherent modules to be the full subcategory of $\bold{Mod}_R$ consisting of coherent modules. 
\end{defn}

\begin{prp}{}{}\\
Let $R$ be a commutative ring. Then $\bold{Coh}_R$ is an abelian category. 
\end{prp}
...
\subsection{The Rees Algebra}
\begin{defn}{The Rees Algebra}{}\\
Let $R$ be a commutative ring. Let $I$ be an ideal of $R$. Define the Rees algebra of $I$ in $R$ to be $$R[It]=\bigoplus_{k=0}^\infty I^k\cdot t^k\subseteq R[t]$$
\end{defn}

\begin{lmm}{}{}\\
Let $R$ be a commutative ring. Let $I$ be an ideal of $R$. Then there is a graded $R$-module isomorphism $$\text{gr}_I(R)\cong\frac{R[It]}{IR[It]}$$
\end{lmm}
...
\begin{defn}{Zariski Pairs}{}\\
Let $R$ be a Noetherian commutative ring. Let $I\subseteq R$ be an ideal. We say that $(R,I)$ is a Zariski pair if $I\subseteq J(R)$. 
\end{defn}

\begin{lmm}{}{}\\
Let $R$ be a Noetherian commutative ring. Let $I\subseteq R$ be an ideal. Then the following are equivalent. 
\begin{itemize}
\item $(R,I)$ is a Zariski pair. 
\item $\bigcap_{n=1}^\infty I^nM=0$ for all finitely generated $R$-module $M$. 
\item $R$ is $I$-adically complete. 
\end{itemize}
\end{lmm}

The theory of Noetherian local rings and graded Noetherian rings are similar because they are both Zariski pairs. 

\begin{lmm}{}{}\\
Let $(R,m)$ be a Noetherian local ring. Then $(R,m)$ is a Zariski pair. 
\end{lmm}

\begin{lmm}{}{}\\
Let $R$ be a Notherian graded ring. Then $(R,R_+)$ is a Zariski pair. 
\end{lmm}

\begin{thm}{Nakayama's Lemma}{}\\
Let $(R,I)$ be a Zariski pair. Let $M$ be a finitely generated $R$-module. Suppose that $IM=M$. Then we have $M=0$. 
\end{thm}
...
\begin{eg}{}{} Let $k$ be a field. Let $d\geq 2$. Let $f\in k[x_1,\dots,x_d]$ be a homogeneous polynomial of degree $s$. Let $A=\frac{k[x_1,\dots,x_d]}{(f)}$. Then we have $$HF_A(n)=\binom{d+n-1}{d-1}-\binom{d+n-1-s}{d-1}$$ 
\begin{proof}
...
\begin{eg}{}{}\\
The Hilbert polynomial of $A=\frac{k[x,y,z,w]}{(x,y)\cap(z,w)}$ is given by $$HP_A(t)=2t-t^2$$
\begin{proof}\\
Recall that we have a short exact sequence \\~\\
\adjustbox{scale=1.0,center}{\begin{tikzcd}
	0 & {\frac{k[x,y,z,w]}{(x,y)\cap(z,w)}} & {\frac{k[x,y,z,w]}{(x,y)}\oplus\frac{k[x,y,z,w]}{(z,w)}} & {\frac{k[x,y,z,w]}{(x,y)+(z,w)}} & 0
	\arrow[from=1-1, to=1-2]
	\arrow[from=1-2, to=1-3]
	\arrow[from=1-3, to=1-4]
	\arrow[from=1-4, to=1-5]
\end{tikzcd}}\\~\\
Notice that the module in the middle is isomorphic to $k[z,w]\oplus k[x,y]$. Using the exact sequence \\~\\
\adjustbox{scale=1.0,center}{\begin{tikzcd}
	0 & {k[z,w]} & {k[z,w]\oplus k[x,y]} & {k[x,y]} & 0
	\arrow[from=1-1, to=1-2]
	\arrow[from=1-2, to=1-3]
	\arrow[from=1-3, to=1-4]
	\arrow[from=1-4, to=1-5]
\end{tikzcd}}\\~\\
gives us $HS_{k[z,w]\oplus k[x,y]}(t)=\frac{2}{(1-t)^2}$. Also, we have $(x,y)+(z,w)=(x,y,z,w)$ in $k[x,y,z,w]$ so the quotient with the ring gives $k$. Thus we have $HS_{\frac{k[x,y,z,w]}{(x,y)+(z,w)}}(t)=1$. Thus we have $$HS_A(t)=HS_{k[z,w]\oplus k[x,y]}(t)-HS_{\frac{k[x,y,z,w]}{(x,y)+(z,w)}}(t)=\frac{2}{(1-t)^2}-1=\frac{2t-t^2}{(1-t)^2}$$ Hence we have $HP_A(t)=2t-t^2$. 
\end{proof}
\end{eg}
...
Let $(R,m)$ be a local Noetherian ring. Let $M$ be a finitely generated $R$-module. Let $I$ be an $m$-primary ideal. Then the following numbers are equal. 
\begin{itemize}
...
\begin{lmm}{}{}\\
Let $R$ be a Noetherian graded ring. Then we have $\dim(R)=\dim(R_{(R_+)})$. 
\end{lmm}

\begin{prp}{}{}\\
Let $R$ be a Noetherian commutative graded ring. Suppose that $R_0$ is a field. Let $M$ be a finitely generated graded $R$-module. Let $I\subseteq R$ be an ideal such that $\sqrt{I}=R_+$. Then the following numbers are equal. 
\begin{itemize}
\item The Krull dimension $$\dim(M)=\dim(R/\text{Ann}_R(M))$$
\item The Hilbert-Samuel degree $$d(M)=\min\{d\in\N\;|\;\lim_{t\to 1}(1-t)^dHS_{\text{gr}_I(M)}(t)<\infty\}$$
\item The minimal number of generators $$\delta_IM=\min\{n\in\N\;|\;x_1,\dots,x_n\in R_+\text{ such that }l_R(M/(x_1,\dots,x_n)M)<\infty\}$$
\end{itemize}
\end{prp}
...
\begin{prp}{}{}\\
Let $(R,m)$ be a local ring. Then we have $$\dim(R)=\dim(\widehat{R})$$
\end{prp}

\pagebreak
\section{Regular Sequences and Depth}
\subsection{Regular Sequences}
\begin{defn}{Regular Elements}{}\\
Let $R$ be a commutative ring. Let $M$ be an $R$-module. Let $x\in R$. We say that $x$ is an $M$-regular element if for all $0\neq m\in M$, $xm\neq 0$. 
\end{defn}
...
\begin{defn}{Regular Sequences}{}\\
Let $R$ be a commutative ring and let $M$ be an $R$-module. Let $I$ be an ideal of $R$. Let $x_1,\dots,x_n\in I$ be an ordered sequence in $R$. We say that the sequence is $M$-regular in $I$ if $x_k$ is a regular element of $\frac{M}{(x_1,\dots,x_{k-1})M}$ for $1\leq k\leq n$. 
\end{defn}

The order of the regular sequence matters in general. 

\begin{eg}{}{}\\
Let $F$ be a field. Then the following are true. 
\begin{itemize}
\item The sequence $x-1,xy,xz$ is regular in $F[x,y,z]$. 
\item The sequence $xy,xz,x-1$ is not regular in $F[x,y,z]$. 
\end{itemize}
\begin{proof}\\
Clearly $x-1$ is a regular element since it is not a zero divisor of $F[x,y,z]$. Now we have $\frac{F[x,y,z]}{(x-1)}\cong F[y,z]$ and the image of $xy$ and $xz$ in the isomorphism is $y$ and $z$ respectively. Then it is clear that $y$ is regular in $F[y,z]$ and $z$ is regular in $F[y,z]/(y)\cong F[z]$. \\

On the other hand, $xy$ is a regular element of $F[x,y,z]$ since it is not a zero divisor. But $xz$ is not a zero divisor of $F[x,y,z]/(xy)$ because multiplication by $y$ gives the zero element. 
\end{proof}
\end{eg}

\begin{lmm}{}{}\\
Let $R$ be a commutative ring. Let $M$ be an $R$-module. If $x_1,\dots,x_n$ is an $M$-regular sequence, then $x_1^r,\dots,x_n^r$ is an $M$-regular sequence for all $r\in\N\setminus\{0\}$. 
\end{lmm}
...
\begin{defn}{Maximal Regular Sequences}{}\\
Let $R$ be a commutative ring. Let $M$ be an $R$-module. Let $x_1,\dots,x_n\in I$ be a regular sequence. We say that the sequence is maximal if for any $y\in I$, $x_1,\dots,x_n,y$ is not a regular sequence. 
\end{defn}
...
\begin{proof}\\
We first need to prove the following: $(x_1,\dots,x_n)$ annihilates $H_k^\text{Kos}(x_1,\dots,x_n;M)$ for all $k$. It suffices to show that $x_i$ annihilates $H_k^\text{Kos}(x_1,\dots,x_n;M)$. I claim that multiplication by $x_i$ is a null homotopic chain map $K_\bullet(x_1,\dots,x_n;M)\to K_\bullet(x_1,\dots,x_n;M)$. WLOG suppose $i=1$. We first decompose the Koszul complex and the chain map into $x_1\otimes\text{id}:K_\bullet(x_1)\otimes_RK_\bullet(x_2,\dots,x_n;M)\to K_\bullet(x_1)\otimes_RK_\bullet(x_2,\dots,x_n;M)$. But the map $x_1:K_\bullet(x_1)\to K_\bullet(x_1)$ is null homotopic via the homotopy $\eta_0=\text{id}_R:R\to R$ and $\eta_k=0$ for $k\neq 0$. Thus multiplication by $x_i$ is a null homotopic chain map $K_\bullet(x_1,\dots,x_n;M)\to K_\bullet(x_1,\dots,x_n;M)$. Descending to homology, the induced chain map $H_k^\text{Kos}(x_1,\dots,x_n;M)\to H_k^\text{Kos}(x_1,\dots,x_n;M)$ is the zero map. But this means that $x_i$ annihilates $H_k^\text{Kos}(x_1,\dots,x_n;M)$. \\

Write $\bold{x}$ to be the sequence $x_1,\dots,x_n$. By functoriality of the Koszul complex, we obtain a short exact sequence of chain complexes: \\
\adjustbox{scale=1.0,center}{\begin{tikzcd}
	0 & {K_\bullet(\bold{x};M)} & {K_\bullet(\bold{x};M)} & {K_\bullet(\bold{x};M/x_iM)} & 0
	\arrow[from=1-1, to=1-2]
	\arrow["{x_i}", from=1-2, to=1-3]
	\arrow[from=1-3, to=1-4]
	\arrow[from=1-4, to=1-5]
\end{tikzcd}}\\~\\
This induces a long exact sequence in homology: \\
\adjustbox{scale=0.85,center}{\begin{tikzcd}
	\cdots & {H_{k+1}^\text{Kos}(\bold{x};M/x_iM)} & {H_k^\text{Kos}(\bold{x};M)} & {H_k^\text{Kos}(\bold{x};M)} & {H_k^\text{Kos}(\bold{x};M/x_iM)} & {H_{k-1}^\text{Kos}(\bold{x};M)} & \cdots
	\arrow[from=1-1, to=1-2]
	\arrow[from=1-2, to=1-3]
	\arrow["{x_i}", from=1-3, to=1-4]
	\arrow[from=1-4, to=1-5]
	\arrow[from=1-5, to=1-6]
	\arrow[from=1-6, to=1-7]
\end{tikzcd}}\\~\\
Since multiplication by $x_i$ annihilates $H_k^\text{Kos}(\bold{x};M)$, we obtain short exact sequences: \\
\adjustbox{scale=1.0,center}{\begin{tikzcd}
	0 & {H_k^\text{Kos}(\bold{x};M)} & {H_k^\text{Kos}(\bold{x};M/x_iM)} & {H_{k-1}^\text{Kos}(\bold{x};M)} & 0
	\arrow[from=1-1, to=1-2]
	\arrow[from=1-2, to=1-3]
	\arrow[from=1-3, to=1-4]
	\arrow[from=1-4, to=1-5]
\end{tikzcd}}\\~\\
We now induct on $n$. When $n=1$, computations in Homological Algebra already shows that $H_1^\text{Kos}(\bold{x};M)=0$. Suppose it is true for some $n$. Since $x_2,\dots,x_n$ is a regular sequence for $M/x_1M$, we know that $H_k^\text{Kos}(\bold{x};M/x_1)=0$ by induction hypothesis. Hence $H_k^\text{Kos}(\bold{x};M)$ for all $k\geq 1$ following the above short exact sequence. 
\end{proof}
\end{prp}

\begin{crl}{}{}\\
Let $R$ be a commutative ring. Let $x_1,\dots,x_n\in R$. If $x_1,\dots,x_n$ is a regular sequence, then $K(x_1,\dots,x_n)$ is a free resolution of $R/(x_1,\dots,x_n)$ as an $R$-module. 
\begin{proof}\\
...
\begin{eg}{}{}\\
Let $R$ be a commutative ring. Then $K(x_1,\dots,x_n)$ is a free resolution for $R$ as an $R[x_1,\dots,x_n]$-module. 
\end{eg}
...
\begin{itemize}
\item If $\text{Ann}_R(N)$ contains an $M$-regular element, then we have $\Hom_R(N,M)=0$. 
\item If $R$ is Noetherian and $M,N$ are finitely generated and $\Hom_R(N,M)=0$, then $\text{Ann}_R(N)$ contains an $M$-regular element. 
\end{itemize}
\end{prp}

\begin{prp}{}{}\\
Let $R$ be a commutative ring. Let $M,N$ be $R$-modules. Let $x_1,\dots,x_n\in\text{Ann}_R(N)$ be an $M$-regular sequence. Then we have $$\Hom_R(N,M/(x_1,\dots,x_n)M)\cong\text{Ext}_R^n(N,M)$$
\end{prp}

\begin{defn}{Depth of a Module}{}\\
Let $R$ be a Noetherian commutative ring. Let $I$ be an ideal of $R$. Let $M$ be a finitely generated $R$-module such that $IM\neq M$. Define the $I$-depth of $M$ to be $$\text{depth}_I(M)=\max\{n\in\N\;|\;x_1,\dots,x_n\in I\text{ is an }M\text{-regular sequence }\}$$
\end{defn}

If $(R,m)$ is a local ring then we write $\text{depth}(M)=\text{depth}_m(M)$. 

\begin{thm}{Ree}{}\\
Let $R$ be a Noetherian commutative ring. Let $I$ be an ideal of $R$. Let $M$ be a finitely generated $R$-module such that $IM\neq M$. Then depth is well defined and is given by $$\text{depth}_I(M)=\min\{i\in\N\;|\;\text{Ext}_R^i(R/I,M)\neq 0\}$$
\end{thm}

\begin{prp}{}{}\\
Let $R$ be a Noetherian commutative ring. Let $I$ be an ideal of $R$. Let the following be an exact sequence of finitely generated $R$-modules \\~\\
\adjustbox{scale=1.0,center}{\begin{tikzcd}
	0 & M_1 & M_2 & M_3 & 0
	\arrow[from=1-1, to=1-2]
	\arrow["f", from=1-2, to=1-3]
	...
	\arrow[from=1-4, to=1-5]
\end{tikzcd}}\\~\\
such that $IM_k\neq M_k$ for $k=1,2,3$. Then the following are true. 
\begin{itemize}
\item $\text{depth}_I(M_2)\geq\min\{\text{depth}_I(M_1),\text{depth}_I(M_3)\}$. 
\item $\text{depth}_I(M_3)\geq\min\{\text{depth}_I(M_1)-1,\text{depth}_I(M_2)\}$. 
\item $\text{depth}_I(M_1)\geq\min\{\text{depth}_I(M_2),\text{depth}_I(M_3)+1\}$. 
\end{itemize}
\end{prp}

\begin{prp}{}{}\\
Let $R$ be a Noetherian commutative ring. Let $I$ be an ideal of $R$. Let $M$ be a finitely generated $R$-module such that $IM\neq M$. Then the following are true. 
\begin{itemize}
\item $\text{depth}_I(M)=\inf\{\text{depth}_I(M_P)\;|\;P\in\text{Spec}(R)\}$. 
\item $\text{depth}_{\sqrt{I}}(M)=\text{depth}_I(M)$. 
\item Let $x_1,\dots,x_n\in I$ be an $M$-regular sequence. Then we have $\text{depth}_I(M/(x_1,\dots,x_n)M)=\text{depth}_I(M)-n$. 
\end{itemize}
\end{prp}
\begin{prp}{}{}\\
...
\begin{prp}{Depth Sensitivity of the Koszul Complex}{}\\
Let $R$ be a Noetherian commutative ring. Let $I=(x_1,\dots,x_n)$ be an ideal of $R$. Let $M$ be a finitely generated $R$-module such that $IM\neq M$. Then we have $$\text{depth}_I(M)=n-\sup\{i\in\N\;|\;H_i^\text{Kos}(x_1,\dots,x_n,M)\neq 0\}$$
\end{prp}
...
We now restrict to the case of Noetherian local rings. 

\begin{thm}{Ischebeck's Theorem}{}\\
Let $(R,m)$ be a Noetherian local ring. Let $M,N$ be non-zero finitely generated $R$-modules. Then we have $$\text{Ext}_R^i(N,M)=0$$ for all $0\leq i\leq\text{depth}_m(M)-\dim(N)$. 
\end{thm}

\begin{lmm}{}{}\\
Let $(R,m)$ be a Noetherian local ring. Let $M$ be an $R$-module. Then $\text{depth}(M)=0$ if and only if $m$ is an associated prime of $M$. 
\begin{proof}
...
\begin{prp}{}{}\\
Let $(R,m)$ be a Noetherian local ring. Let $M\neq 0$ be a finitely generated $R$-module. Then every $M$-regular sequence is extendable to a system of parameters. 
\end{prp}

As a corollary, we must have $\text{depth}(M)\leq\dim(M)$. 

\begin{prp}{}{}\\
Let $(R,m)$ be a Noetherian local ring. Let $M\neq 0$ be a finitely generated $R$-module. Let $P\in\text{Ass}(M)$. Then we have $$\text{depth}(M)\leq\dim(R/P)$$
\end{prp}
...
\begin{crl}{}{}\\
Let $R$ be a commutative ring. Let $M$ be an $R$-module. Then we have $$\text{pd}_R(M)=\min\{d\in\N\;|\;\text{Ext}_R^{d+1}(M,N)=0\text{ for all }R\text{-modules }N\}$$
\end{crl}

\begin{crl}{}{}\\
Let $R$ be a Noetherian commutative ring. Let $M$ be a finitely generated $R$-module. Then we have $$\text{depth}_I(M)\leq\text{pd}_R(R/I)$$
\end{crl}

\subsection{Minimal Resolutions}
Let $R$ be a commutative ring. Recall that if $R$ is a local ring or if $R$ is graded, then any finitely generated modules that are projective must be free. Thus projective resolutions and free resolutions of these rings amount to the same thing. 

\begin{defn}{Minimal Free Resolutions for Noetherian Local Rings}{}\\
Let $(R,m)$ be a Noetherian local ring. Let $M$ be a finitely generated $R$-module. Let $(F_\bullet,d)$ be a free resolution of $M$. We say that $F_\bullet$ is minimal if $\im(F_n\to F_{n-1})\subseteq mF_{n-1}$ for all $n$. 
\end{defn}

\begin{prp}{}{}\\
Let $(R,m)$ be a Noetherian local ring. Let $M$ be a finitely generated $R$-module. Let $(F_\bullet,d)$ be a free resolution of $M$. Then the following are equivalent. 
\begin{itemize}
\item $(F_\bullet,d)$ is a minimal free resolution. 
\item $\rank(F_n)=\dim_{R/m}(\text{Tor}_i^R(M,R/m))$ for all $n$. 
\item $\rank(F_n)=\dim_{R/m}(\text{Ext}_R^i(M,R/m))$ for all $n$. 
\item $(F_\bullet,d)$ is isomorphic to a chain complex of the form \\
\adjustbox{scale=1.0,center}{\begin{tikzcd}
	\cdots & {R^{\beta_n}} & \cdots & {R^{\beta_0}} & 0
	\arrow[from=1-1, to=1-2]
	\arrow[from=1-2, to=1-3]
	\arrow[from=1-3, to=1-4]
	\arrow[from=1-4, to=1-5]
\end{tikzcd}}\\
where $R^{\beta_0}\to M$ is the map given by choosing a minimal set of generators of $M$, and $R^{\beta_n}\to R^{\beta_{n-1}}$ is the map given by choose a minimal set of generators of $\ker(R^{\beta_{n-1}}\to R^{\beta_{n-2}})$. 
\end{itemize}
\end{prp}

\begin{prp}{}{}\\
Let $(R,m)$ be a Noetherian local ring. Let $M$ be a finitely generated $R$-module. Let $(F_\bullet,d)$ be a minimal free resolution of $M$ given by $$F_n=R^{\beta_n}$$ Then we have $$\beta_n=\dim_{R/m}(\text{Tor}_i^R(M,R/m))$$
\end{prp}

\begin{prp}{}{}\\
Let $(R,m)$ be a Notherian local ring. Let $M$ be a finitely generated $R$-module. Then we have $$\text{pd}_R(M)=\text{sup}\{i\in\N\;|\;\text{Tor}_i^R(R/m,M)\neq 0\}$$
\end{prp}

\begin{defn}{Minimal Free Resolutions for Graded Rings}{}\\
Let $R$ be a Noetherian graded ring such that $R_0$ is a field. Let $M$ be a finitely generated graded $R$-module. Let $(F_\bullet,d)$ be a graded free resolution of $M$. We say that $F_\bullet$ is minimal if $\im(F_n\to F_{n-1})\subseteq mF_{n-1}$ for all $n$. 
\end{defn}

Recall Ext and Tor also has graded versions. 

\begin{prp}{}{}\\
Let $R$ be a Noetherian graded ring such that $R_0$ is a field. Let $M$ be a finitely generated graded $R$-module. Let $(F_\bullet,d)$ be a graded free resolution of $M$. Then the following are equivalent. 
\begin{itemize}
\item $(F_\bullet,d)$ is a minimal graded free resolution. 
\item $(F_\bullet,d)$ is isomorphic to a chain complex of the form \\
\adjustbox{scale=1.0,center}{\begin{tikzcd}
	\cdots & {\bigoplus_{j\in\Z}R(-j)^{\beta_{n,j}}} & \cdots & {\bigoplus_{j\in\Z}R(-j)^{\beta_{0,j}}} & 0
	\arrow[from=1-1, to=1-2]
	\arrow[from=1-2, to=1-3]
	\arrow[from=1-3, to=1-4]
	\arrow[from=1-4, to=1-5]
\end{tikzcd}}\\
where $\bigoplus_{j\in\Z}R(-j)^{\beta_{0,j}}\to M$ is the map given by choosing a minimal set of generators of $M$ degree wise , and $$\bigoplus_{j\in\Z}R(-j)^{\beta_{n,j}}\to\bigoplus_{j\in\Z}R(-j)^{\beta_{n-1,j}}$$ is the map given by choose a minimal set of generators of $$\ker\left(\bigoplus_{j\in\Z}R(-j)^{\beta_{n-1,j}}\to\bigoplus_{j\in\Z}R(-j)^{\beta_{n-2,j}}\right)$$ degree wise. 
\end{itemize}
\end{prp}

\begin{crl}{}{}\\
Let $R$ be a Noetherian graded ring such that $R_0$ is a field. Let $M$ be a finitely generated graded $R$-module. Let $(F_\bullet,d)$ be a minimal graded free resolution of $M$ given by $$F_n=\bigoplus_{j\in\Z}R(-j)^{\beta_{n,j}}$$ Then we have $$\beta_{n,j}=\dim_{R_0}(\text{Tor}_n^R(M,R_0)_j)$$
\end{crl}

\subsection{Global Dimensions}
\begin{defn}{Global Dimension}{}\\
Let $R$ be a commutative ring. Define the global dimension of $R$ to be $$\text{gl dim}(R)=\sup\{\text{pd}(M)\;|\;M\in{_R\bold{Mod}}\}$$
\end{defn}
...
\begin{lmm}{}{}\\
Let $(R,m)$ be a Noetherian local ring. Let $M$ be a finitely generated $R$-module. If $x\in m$ is $R$-regular and $M$-regular, then we have $$\text{pd}_R(M)=\text{pd}_{R/(x)}\left(\frac{M}{xM}\right)$$
\end{lmm}

\begin{thm}{Auslander–Buchsbaum Formula}{}\\
Let $(R,m)$ be a Noetherian local ring. Let $M$ be a finitely generated $R$-module. If $\text{pd}_R(M)$ is finite, then we have $$\text{pd}_R(M)+\text{depth}_m(M)=\text{depth}_m(R)$$
\end{thm}
...
\begin{thm}{Hilbert's Syzygy Theorem}{}\\
Let $k$ be a field. Let $M$ be a finitely generated module over $k[x_1,\dots,x_n]$. Then the following are true. 
\begin{itemize}
\item $M$ has a free resolution of length at most $n$. 
\item If $M$ is graded, then $M$ has a graded free resolution of length at most $n$. 
\end{itemize}
\end{thm}

\pagebreak
\section{Cohen-Macaulay Rings}
\subsection{Cohen-Macaulay Rings and Modules}
...
\begin{defn}{Cohen-Macaulay Modules over Noetherain Local Rings}{}\\
Let $(R,m)$ be a Noetherian local ring. Let $M$ be a non-zero finitely generated $R$-module. We say that $M$ is Cohen-Macaulay if $$\dim(M)=\text{depth}(M)$$ By convention $M=0$ is also a Cohen-Macaulay module. 
\end{defn}

In the case that $M=R$, we say that $R$ is a Cohen-Macaulay ring if $$\dim(R)=\text{depth}(R)$$ In general, we know that $\text{depth}(R)\leq\dim(R)$ because every regular sequence can be extended to a system of parameters, but there is no guarantee that the extended sequence is then a regular sequence. The condition that $\dim(R)=\text{depth}(R)$ then refers to the existence of a regular sequence that is also a system of parameters. This means that system of parameters in a Cohen-Macaulay ring coincides with maximal regular sequences. \\

We first describe some properties of Cohen-Macaulay modules. 

\begin{prp}{}{}\\
Let $(R,m)$ be a Noetherian local ring. Let $M$ be a Cohen-Macaulay $R$-module. Then the following are true. 
\begin{itemize}
\item $\text{depth}(M)=\dim(R/P)$ for all $P\in\text{Ass}(M)$. 
\item $M$ has no embedded associated primes. 
\end{itemize}
\end{prp}

\begin{prp}{}{}\\
Let $(R,m)$ be a Noetherian local ring. Let $M$ be a Cohen-Macaulay $R$-module. Let $I$ be an ideal of $R$. Then we have $$\text{depth}_I(M)=\dim(M)-\dim(M/IM)$$
\end{prp}

\begin{crl}{}{}\\
Let $(R,m)$ be a Cohen-Macaulay local ring. Let $I\neq R$ be an ideal. Then we have $$\text{ht}(I)=\text{depth}(I)$$
\end{crl}

\begin{prp}{}{}\\
Let $(R,m)$ be a Noetherian local ring. Let $M$ be a Cohen-Macaulay $R$-module. Let $x_1,\dots,x_n\in R$. Then the following are equivalent. 
\begin{itemize}
\item $x_1,\dots,x_n$ is an $M$-regular sequence. 
\item $\dim(M/(x_1,\dots,x_n)M)=\dim(M)-n$. 
\item $x_1,\dots,x_n$ is extendable to a system of parameters. 
\end{itemize}
\end{prp}

\begin{crl}{}{}\\
Let $(R,m)$ be a Noetherian local ring. Let $M$ be a Cohen-Macaulay $R$-module. Then every system of parameters is a maximal $M$-regular sequence. 
\end{crl}

\begin{defn}{Cohen-Macaulay Modules}{}\\
Let $R$ be a Noetherian commutative ring. Let $M$ be an $R$-module. We say that $M$ is a Cohen-Macaulay if $M_m$ is a Cohen-Macaulay module for all maximal ideals $m\in\text{Supp}(M)$. 
\end{defn}

\begin{prp}{}{}\\
Let $R$ be a Noetherian commutative ring. Let $M$ be a finitely generated $R$-module. Let $x_1,\dots,x_r$ be an $M$-regular sequence. Then the following are true. 
\begin{itemize}
\item If $M$ is Cohen-Macaulay, then $M/(x_1,\dots,x_r)M$ is Cohen-Macaulay. 
\item Suppose that $R$ is a local ring. Then $M$ is Cohen-Macaulay if and only if $M/(x_1,\dots,x_r)M$ is Cohen-Macaulay. 
\end{itemize}
\end{prp}

\begin{prp}{}{}\\
Let $R$ be a Noetherian commutative ring. Let $M$ be a Cohen-Macaulay $R$-module. Let $P\in\text{Spec}(R)$. Then the following are true. 
\begin{itemize}
\item $M_P$ is a Cohen-Macaulay $R_P$-module. 
\item $\text{depth}_P(M)=\text{depth}_{PR_P}(M_P)$. 
\item Suppose that $R$ is a local ring. Then we have $$\dim(M)=\dim(M_P)+\dim(M/PM)$$
\end{itemize}
\end{prp}

\begin{prp}{}{}\\
Let $R$ be a Noetherian commutative ring. Then the following are true. 
\begin{itemize}
...
Let $(R,m_R)$ and $(S,m_S)$ be Noetherian local rings. Let $\varphi:R\to S$ be a local homomorphism. Suppose that the following are true. 
\begin{itemize}
\item $R$ is regular. 
\item $S$ is Cohen-Macaulay. 
\item $\frac{S}{m_S}=S\otimes_R\frac{R}{m}$ has dimension $\dim(S)-\dim(R)$. 
\end{itemize}
Then $\varphi$ is flat. 
\end{thm}
...
\begin{defn}{Regular Local Rings}{}\\
Let $(R,m)$ be a Noetherian local ring. We say that $R$ is a regular local ring if $$\dim(R)=\dim_{R/m}\left(\frac{m}{m^2}\right)$$
\end{defn}

\begin{defn}{Regular System of Parameters}{}\\
Let $(R,m)$ be a Noetherian local ring. A regular system of parameters is a system of parameters of $R$ that generate $m$. 
\end{defn}

\begin{prp}{}{}\\
Let $(R,m)$ be a Notherian local ring. Then $R$ is a regular local ring if and only if $m$ admits a regular system of parameters. 
\end{prp}

Consequently, regular system of parameters are also maximal $M$-regular sequences. 

\begin{prp}{}{}\\
Let $(R,m)$ be a regular local ring. Let $x_1,\dots,x_i\in m$ be elements in $m$. Then the following are equivalent. 
\begin{itemize}
...
\item $\frac{R}{(x_1,\dots,x_i)}$ is a regular local ring of dimension $\dim(R)-i$. 
\end{itemize}
\end{prp}

\begin{prp}{}{}\\
Let $(R,m)$ be a Noetherian local ring of dimension $d$. Let $x_1,\dots,x_d$ be minimal generators of $m$. Then the following are equivalent. 
\begin{itemize}
\item $R$ is a regular local ring. 
\item $x_1,\dots,x_d$ is an $R$-regular sequence. 
\item There is an isomorphism of graded algebras $$\text{gr}_m(R)\cong k[y_1,\dots,y_d]$$ given by $[x_i]\mapsto y_i$. 
\end{itemize}
\end{prp}

\begin{crl}{}{}\\
Let $(R,m)$ be a regular local ring. Then $R$ is Cohen-Macaulay. 
\end{crl}

\begin{lmm}{}{}\\
Let $R$ be commutative ring. Then $R$ is a regular local ring of dimension $1$ if and only if $R$ is a DVR. 
\begin{proof}
...
Let $(R,m)$ be a Noetherian local ring. Then the following are equivalent. 
\begin{itemize}
\item $R$ is a regular local ring. 
\item $\text{pd}(M)<\infty$ for all finitely generated $R$-modules $M$. 
\item $\text{pd}(R/m)<\infty$. 
\end{itemize}
\end{thm}
...
\begin{thm}{Auslander–Buchsbaum-Nagata}{}\\
Let $R$ be a regular local ring. Then $R$ is a UFD. 
\end{thm}
...
Let $R$ be a Noetherian commutative ring. Let $n\in\N$. We say that $X$ satisfies $R_n$ if $R_P$ is a regular local ring for all prime ideals $P\subseteq R$ such that $\text{ht}(P)\leq n$. 
\end{defn}

\begin{defn}{Serre's $S_n$ Criterion}{}\\
Let $R$ be a Noetherian commutative ring. Let $n\in\N$. We say that $X$ satisfies $S_n$ if $$\text{depth}(R_P)\geq\min\{n,\text{ht}(P)\}$$ for all prime ideals $P\subseteq R$. 
\end{defn}

\begin{prp}{}{}\\
Let $R$ be a Noetherian commutative ring. Then the following are true. 
\begin{itemize}
\item $R$ is reduced if and only if $R$ satisfies $R_0$ and $S_1$. 
\item $R$ is normal if and only if $R$ satisfies $R_1$ and $S_2$. 
\item $R$ is Cohen-Macaulay if and only if $R$ satisfies $S_n$ for all $n\geq 0$. 
\end{itemize}
\end{prp}
...
\begin{defn}{Gorenstein Local Rings}{}\\
Let $R$ be a Noetherian local ring. We say that $R$ is Gorenstein if $$\text{id}_R(R)<\infty$$
\end{defn}

\begin{defn}{Gorenstein Rings}{}\\
Let $R$ be a Noetherian commutative ring. We say that $R$ is Gorenstein if $R_m$ is a Gorenstein local ring for all maximal ideals $m$. 
\end{defn}

\begin{prp}{}{}\\
Let $R$ be a Gorenstein ring. Let $P\in\text{Spec}(R)$. Then $R_P$ is Gorenstein. 
\end{prp}

\begin{prp}{}{}\\
Let $R$ be a Noetherian commutative ring. Let $x_1,\dots,x_n$ be an $R$-regular sequence. Then the following are true. 
\begin{itemize}
\item If $R$ is Gorenstein, then $R/(x_1,\dots,x_n)$ is Gorenstein. 
\item Suppose that $R$ is local . Then $R$ is Gorenstein if and only if $R/(x_1,\dots,x_n)$ is Gorenstein. 
\end{itemize}
\end{prp}

\begin{prp}{}{}\\
Let $R$ be a Noetherian local ring. Then $R$ is Gorenstein if and only if $\widehat{R}$ is Gorenstein. 
\end{prp}
...
\begin{crl}{}{}\\
Let $R$ be a regular local ring. Then $R$ is Gorenstein. 
\end{crl}

\subsection{The Canonical Module}
...
Let $A$ be a commutative ring. Let $B$ be an $A$-algebra. Define the module of Kähler differentials to be a $B$-module $\Omega_{B/A}^1$ together with a $B$-module homomorphism $d_u:B\to\Omega_{B/A}^1$ satisfying the following universal property: For any $B$-module $M$ and any $A$-derivation $d:B\to M$, there exists a unique $B$-module homomorphism such that the following diagram commutes: \\~\\
\adjustbox{scale=1.0,center}{\begin{tikzcd}
	B & {\Omega_{B/A}^1} \\
	& M
...
\item Let $C$ be an $A$-algebra. Then there is an isomorphism of $B$-modules $$\Omega_{C/A}^1\otimes_AB\cong\Omega_{B\otimes_AC/B}^1$$ induced by the universal property of the module. 
\end{itemize}
\end{prp}
