...
\subsection{Minimal Resolutions of Local Rings}
...
\begin{defn}{Minimal Free Resolutions of Local Rings}{}\\
Let $(R,m)$ be a local ring. Let $M$ be a finitely generated $R$-module. Let $(F_\bullet,d)$ be a free resolution of $M$. We say that $F_\bullet$ is minimal if $d\otimes_R\text{id}_{R/m}=0$ and $F_0\otimes_RR/m\to M\otimes_RR/m$ is an isomorphism. 
\end{defn}

\begin{lmm}{}{}\\
Let $(R,m)$ be a local ring. Let $M$ be a finitely generated $R$-module. Let $(F_\bullet,d)$ be a free resolution of $M$. Then $F_\bullet$ is minimal if and only if for each $\im(d_i)\subseteq mF_{i-1}$ for all $i\in\N$. 
\end{lmm}

\begin{prp}{}{}\\
Let $(R,m)$ be a local ring. Let $M$ be a finitely generated $R$-module. If $R$ is Noetherian, then a minimal free resolution exists and is unique up to isomorphism. 
\end{prp}

\begin{prp}{}{}\\
Let $(R,m)$ be local ring. Let $M$ be a finitely generated $R$-module. Then we have $$\text{pd}_R(M)=\sup\{i\in\N\;|\;\text{Tor}_i^R(R/m,M)\}$$
\end{prp}

\begin{defn}{Minimal Free Resolutions of Graded Modules}{}\\
Let $R$ be a Noetherian $\N$-graded ring such that $R_0$ is a field. Let $M$ be a finitely generated graded $R$-module. Let $(F_\bullet,d)$ be a graded free resolution of $M$. We say that $F_\bullet$ is minimal if $d_i\otimes_RR_0=0$ and $F_0\otimes_RR_0\to M\otimes_RR_0$ is an isomorphism. 
\end{defn}

\begin{lmm}{}{}\\
Let $R$ be a Noetherian $\N$-graded ring such that $R_0$ is a field. Let $M$ be a finitely generated graded $R$-module. Let $(F_\bullet,d)$ be a graded free resolution of $M$. Then $F_\bullet$ is minimal if and only if for each $\im(d_i)\subseteq mF_{i-1}$ for all $i\in\N$. 
\end{lmm}

\begin{prp}{}{}\\
Let $R$ be an $\N$-graded ring such that $R_0$ is a field. Let $M$ be a finitely generated graded $R$-module. Let $(F,d)$ be a minimal free resolution of $M$. Then we have $$\text{Tor}_i^R(M,R_0)=F_i\otimes_RR_0$$
\end{prp}

\begin{prp}{}{}\\
Let $k$ be a field. Let $M$ be a finitely generated graded $k[x_1,\dots,x_n]$-module where $\deg(x_i)=1$. Then a minimal graded free resolution of $M$ exists and is unique up to isomorphism. 
\end{prp}
