...
Let $R$ be a commutative graded ring. Let $P$ be a homogeneous prime ideal of $R$. Let $T=\{r\in R\setminus P\;|\;r\text{ is homogeneous }\}$. Define the localization of $R$ at $P$ as a graded ring to be $$R_P=T^{-1}R$$
\end{defn}
