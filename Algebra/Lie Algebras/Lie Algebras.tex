...
\begin{lmm}{}{} \\Let $V$ and $W$ be Lie algebras over a field $K$. Let $F:V\to W$ be a Lie algebra homomorphism. Then $\ker(F)$ is a Lie subalgebra of $V$. 
\begin{proof}
...
\begin{lmm}{}{} \\Let $V$ be a Lie algebra. Then then the adjoint homomorphism $\text{ad}:V\to\text{End}(V)$ is a Lie algebra homomorphism. 
\begin{proof}~\\
\begin{itemize}
...
\begin{prp}{}{} \\Let $k$ be a field. Let $V$ be a vector space over $k$. Let $L$ be a Lie-subalgebra of $\mathfrak{gl}_k(V)$. Let $I$ be an ideal of $L$. Then $$V_0=\{v\in V\;|\;T(v)=0\text{ for all }T\in I\}$$ is an $L$-invariant subspace of $V$. 
\begin{proof}
...
\begin{prp}{}{} \\Let $k$ be a field. Let $V$ be a finite dimensional vector space over $k$. Let $L$ be a Lie-subalgebra of $\mathfrak{gl}_k(V)$. Let $I$ be an ideal of $L$. Let $\lambda$ be a weight of $I$. Then $V_\lambda$ is an $L$ invariant subspace of $V$. 
\begin{proof}
...
\begin{prp}{}{} \\Let $L$ be a Lie algebra of dimension $1$. Then $L$ is abelian. 
\begin{proof}
...
\begin{lmm}{}{} \\Let $L_1,L_2$ be Lie algebras. Let $\phi:L_1\to L_2$ be a Lie algebra homomorphism. Then $$\phi(L^k)=(\phi(L))^k$$ for all $k\in\N$. 
\begin{proof}
...
\begin{eg}{}{} \\Let $n\in\N$ such that $n\geq 2$. Let $k$ be a field. Then $\mathfrak{u}_n(k)$ is nilpotent. 
\begin{proof}
...
\begin{thm}{Engel's Theorem}{} \\Let $L$ be a finite dimensional Lie algebra. Then $L$ is nilpotent if and only if all $x\in L$ are ad-nilpotent. 
\begin{proof}
...
\begin{prp}{}{} \\Let $L$ be a Lie algebra of dimension $2$. Then $L$ is soluble. 
\begin{proof}
...
\begin{eg}{}{} \\The Lie algebras $\mathfrak{gl}_2(\C)$ and $\mathfrak{sl}_2(\C)$ are not soluble. 
\begin{proof}
...
\begin{eg}{}{} \\Let $n\geq 2$. Then $\mathfrak{b}_2(\C)$ is soluble. 
\begin{proof}
...
\begin{prp}{}{} \\Let $L$ be a Lie algebra over $\C$. Then $L$ is soluble if and only if $[L,L]$ is nilpotent. 
\begin{proof}
...
\begin{lmm}{}{} \\Let $L$ be a Lie algebra. Then there exists a unique soluble ideal $S$ of $L$ such that for any soluble ideal $J\subseteq L$, we have $J\subseteq S$. 
\begin{proof}
...
\begin{lmm}{}{} \\Let $L$ be a Lie algebra. If $L$ is semisimple, then $\dim(L)\geq 3$. 
\begin{proof}
Any Lie algebra of dimension $1$ or $2$ must be soluble, and cannot be semisimple. 
\end{proof}
\end{lmm}

\begin{lmm}{}{} \\Let $L$ be a Lie algebra. Then $L/\text{rad}(L)$ is semisimple. 
\begin{proof}
...
\begin{lmm}{}{} \\Let $L$ be a Lie algebra. Then $L$ is not semisimple if and only if $L$ contains a non-trivial abelian ideal. 
\begin{proof}
...
\begin{eg}{}{} \\$\mathfrak{sl}_2(\C)$ is a simple Lie algebra. 
\begin{proof}
...
\begin{lmm}{}{} \\Let $L$ be a finite dimensional Lie algebra. Let $I$ be an ideal of $L$. Then we have $$k_I=k_L|_{I\times I}$$ 
\begin{proof}
...
\begin{prp}{}{} \\Let $V$ be a vector space over a field $k$. Let $L\leq\mathfrak{gl}(V)$ be a Lie sub-algebra. If $\text{tr}(xy)=0$ for all $x,y\in L$, then $L$ is soluble. 
\begin{proof}
...
\begin{lmm}{}{} \\Let $L$ be a Lie algebra. Let $I$ be an ideal of $I$. Then $I^\perp$ is an ideal of $L$. 
\begin{proof}
...
\begin{eg}{}{} \\For all $n\geq 2$, $\mathfrak{sl}_n(\C)$ is semi-simple. 
\begin{proof}
...
\begin{lmm}{}{} \\Let $\F$ be a field. Let $V$ be an algebra over $\F$. Then $\text{Der}_\F(V)$ is a Lie sub-algebra of $\mathfrak{gl}(V)$. 
\begin{proof}
...
\begin{lmm}{}{} \\Let $\F$ be a field. Let $L$ be a Lie algebra over $\F$. Then $\text{ad}(L)$ is an ideal of $\text{Der}_\F(L)$. 
\begin{proof}
...
\begin{prp}{}{} \\Let $L$ be a semisimple Lie algebra over $\C$. Then $$\text{Der}_\C(L)=\{\text{ad}(x):L\to L\;|\;x\in L\}=\text{ad}(L)$$ In other words, the only derivations of $L$ is given exactly by the adjoints. 
\begin{proof}
...
\begin{lmm}{}{} \\Let $L$ be a semisimple Lie algebra over $\C$. Let $x\in L$ be an element. Then there exists a unique abstract Jordan decomposition of $x$. 
\begin{proof}
...
\begin{lmm}{}{} \\Let $L$ be a Lie algebra over $k$. Then above bijection restricts to a bijection: $$\{W\text{ an }L\text{-submodule of }L\}\;\;\overset{1:1}{=}\;\;\{\text{Ideals of }L\}$$ 
\begin{proof}
...
\begin{prp}{}{} \\Let $L$ be a semisimple Lie algebra over $\C$. Then we have $$H=C_L(H)=C_L(h_0)$$ for any $h_0\in H$ such that $\dim(C_L(h_0))\leq\dim(C_L(H))$ for all $h\in H$. 
\begin{proof}
...
\begin{eg}{}{} \\A Cartan sub-algebra of $\mathfrak{sl}_2(\C)$ is $\C\langle h\rangle$, and we obtain a decomposition $$\mathfrak{sl}_2(\C)=\C\langle h\rangle\oplus L_\alpha\oplus L_{-\alpha}$$ where $\alpha(h)=2$. 
\begin{proof}
...
\begin{lmm}{}{} \\Let $L$ be a semisimple Lie algebra over $\C$. Let $\Phi$ be the set of roots relative to some Cartan sub-algebra of $L$. Let $\alpha\in\Phi$. Then there is a decomposition $$H\oplus\bigoplus_{c\alpha\in\Phi}L_{c\alpha}=\ker(\alpha)\oplus M_\alpha$$ 
\begin{proof}
...
\begin{prp}{}{} \\Let $L$ be a semi-simple Lie algebra over $\C$. Let $\Phi$ be the set of roots relative to some Cartan sub-algebra of $L$. Let $\alpha\in\Phi$. If $c\alpha\in\Phi$, then $c=\pm1$. 
\begin{proof}
...
\begin{prp}{}{} \\Let $L$ be a semi-simple Lie algebra over $\C$. Let $\Phi$ be the set of roots relative to some Cartan sub-algebra of $L$. Let $\alpha\in\Phi$. Then we have $$\dim(L_\alpha)=1$$ 
\begin{proof}
