...
\begin{eg}{}{}\\
We have $\Q(\sqrt{2}+\sqrt{3})=\Q(\sqrt{2},\sqrt{3})$. 
\begin{proof}\\
Clearly we have $\Q(\sqrt{2}+\sqrt{3})\subseteq\Q(\sqrt{2},\sqrt{3})$. It remains to show that $[\Q(\sqrt{2}+\sqrt{3}),\Q]=[\Q(\sqrt{2},\sqrt{3})]=4$. Notice that $\sqrt{2}+\sqrt{3}$ satisfies the polynomial $x^4-10x^2+1\in\Q[x]$. By the generalized Gauss's lemma, this element is irreducible in $\Q[x]$ if and only if it is irreducible in $\Z[x]$. By Eisenstein's criterion with $P=(2)$, we conclude that $x^4-10x^2+1$ is irreducible. Then we have $[\Q(\sqrt{2}+\sqrt{3}),\Q]=\deg(\min(\Q,\sqrt{2}+\sqrt{3}))=4$. 
\end{proof}
\end{eg}
