...
\subsection{Extensions and the Ext Groups}
...
\pagebreak
\section{Graded Ext and Tor Groups}
...
\subsection{Graded Injective Modules}
\begin{defn}{Injective Modules}{}\\
Let $R$ be a graded ring. Let $I$ be a graded $R$-module. We say that $I$ is injective if for all short exact sequences of graded $R$-modules \\~\\
\adjustbox{scale=1.0,center}{\begin{tikzcd}
	0 & {M_1} & {M_2} & {M_3} & 0
	\arrow[from=1-1, to=1-2]
	\arrow[from=1-2, to=1-3]
...
\adjustbox{scale=1.0,center}{\begin{tikzcd}
	...
	\arrow[from=1-4, to=1-5]
\end{tikzcd}}\\~\\
is an exact sequence of graded $R$-modules. 
\end{defn}
...
\subsection{Projective Modules}
\begin{defn}{Projective Modules}{}\\
Let $R$ be a graded ring. Let $P$ be a graded $R$-module. We say that $P$ is projective if for all short exact sequences of graded $R$-modules \\
\adjustbox{scale=1.0,center}{\begin{tikzcd}
	0 & {M_1} & {M_2} & {M_3} & 0
	\arrow[from=1-1, to=1-2]
	\arrow[from=1-2, to=1-3]
