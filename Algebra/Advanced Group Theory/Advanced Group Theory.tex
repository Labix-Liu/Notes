...
\begin{defn}{The Words of a Set}{} Let $S$ be a set. Let $T=S\times\{-1,1\}$. A word of $S$ of length $n\in\N\setminus\{0\}$ is a map of sets $\omega:\{1,\dots,n\}\to T$. Such a word is denoted by $$s_1\cdots s_n$$ where $s_k=\omega(k)$. Define the empty word to be the unique map $\emptyset\to T$. 
\end{defn}
