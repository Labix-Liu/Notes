...
et $V$ be an inner product space over $\R$ or $\C$. Let $T:V\to V$ be a linear map. Let $\{e_1,\dots,e_n\}$ be an orthonormal basis. Define the trace of $T$ to be $$\text{tr}(T)=\sum_{i=1}^{\dim(V)}\langle T(e_i),e_i\rangle$$
\end{defn}
