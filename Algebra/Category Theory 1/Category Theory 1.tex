...
The universal property of the inverse limit is given by the following: For $C\in\text{Obj}(\mC)$ and maps $\lambda_i:C\to X(i)$, there exists a unique map $u:C\to\lim_{(\N,\leq)^{\text{op}}}X$ such that the following diagram commutes: \\
\adjustbox{scale=1.0,center}{\begin{tikzcd}
