...
We mostly consider the case where $T$ is finite. In this case, we may replace the underlying set $T$ by $\{1,\dots,n\}$ by a suitable $n\in\N$. We think of the set $T$ is the set of vertices, and each subset of $T$ determines a face of the complex. 
...
Let $T_1,T_2$ be sets. Let $S_1,S_2$ be simplicial complexes on $T_1$ and $T_2$ respectively. Let $f:T_1\to T_2$ be a function. We say that $f$ is a simplicial map if for each $\sigma\in S_1$, we have $f(\sigma)\in S_2$. 
\end{defn}

\begin{lmm}{}{}\\
Let $T_1,T_2,T_3$ be sets. Let $S_1,S_2,S_3$ be simplicial complexes on $T_1,T_2,T_3$ respectively. Let $f:T_1\to T_2$ and $g:T_2\to T_3$ be simplicial maps. Then $g\circ f$ is a simplicial map. 
\end{lmm}

\begin{defn}{Isomorphism of Simplicial Complexes}{}\\
Let $T_1,T_2$ be sets. Let $S_1,S_2$ be simplicial complexes on $T_1$ and $T_2$ respectively. Let $f:T_1\to T_2$ be a function. We say that $f$ is an isomorphism if there exists a simplicial map $g:T_2\to T_2$ such that $$g\circ f=\text{id}_{T_1}\;\;\;\text{ and }\;\;\;f\circ g=\text{id}_{T_2}$$
\end{defn}
...
Let $T$ be a set. Let $S$ be an abstract simplicial complex on $T$. Define the barycentric subdivision of $S$ to be the abstract simplicial complex $$\text{Bd}(S)=\bigcup_{i=0}^\infty\{\{v_0,\dots,v_k\}\subseteq\mP(S)\;|\;v_i\subset v_{i+1}\}$$ on $S$. 
\end{defn}
...
Let $T$ be a set. Let $S$ be an abstract simplicial complex on $T$. Let $n\in\N$. Let $\phi:T\to\R^n$ be a function. Define the geometric realization of $T$ with respect to $\phi$ to be the space $$\abs{S}_\phi=\bigcup_{\sigma\in S}[\phi(s)\;|\;s\in\sigma]$$
\end{defn}

\begin{lmm}{}{}\\
Let $T$ be a set. Let $S$ be a simplicial complex on $T$. Then $\abs{S}$ and $\abs{\text{Bd}(S)}$ are homeomrophic. 
\end{lmm}

\begin{defn}{Affine Embedding}{}\\
Let $T$ be a set. Let $S$ be an abstract simplicial complex on $T$. Let $\phi:T\to\R^n$ be a function. We say that $\abs{S}_\phi$ is an affine embedding if $\phi$ is injective. 
\end{defn}

\begin{prp}{}{}\\
Let $T$ be a set. Let $S$ be an abstract simplicial complex on $T$. Let $\phi:T\to\R^n$ and $\psi:T\to\R^m$ be affine embeddings. Then $\abs{S}_\phi$ and $\abs{S}_\psi$ are homeomorphic. 
\end{prp}
...
Let $T_1,T_2$ be sets. Let $S_1,S_2$ be simplicial complexes on $T_1$ and $T_2$ respectively. Let $\phi_1:T_1\to\R^n$ and $\phi_2:T_2\to\R^m$ be affine embeddings. Let $f:T_1\to T_2$ be a simplicial map. Define the geometric realization of $f$ to be the function $$\abs{f}:\abs{S_1}_{\phi_1}\to\abs{S_2}_{\phi_2}$$ given as follow. For each $x\in\abs{S_1}$, there exists $\lambda_v\in\R$ such that $x=\sum_{v\in T_1}\lambda_v\phi_1(v)$ and $\sum_{v\in T_1}\lambda_v=1$. Then define $$\abs{f}(x)=\sum_{v\in T_1}\lambda_v\psi(f(v))$$
\end{defn}

\begin{prp}{}{}\\
Let $T_1,T_2$ be sets. Let $S_1,S_2$ be simplicial complexes on $T_1$ and $T_2$ respectively. Let $f:T_1\to T_2$ be a simplicial map. Then the following are true. 
\begin{itemize}
\item Let $\sigma\in S_1$. Then we have $$\abs{f}(\abs{\sigma})=\abs{f(\sigma)}$$
\item Let $\sigma\in S_1$. Then $\abs{f}|_{\abs{\sigma}}$ is affine linear. 
\end{itemize}
\end{prp}

\begin{lmm}{}{}\\
Let $T_1,T_2,T_3$ be sets. Let $S_1,S_2,S_3$ be simplicial complexes on $T_1,T_2,T_3$ respectively. Let $f:T_1\to T_2,g:T_2\to T_3$ be a simplicial map. Then we have $$\abs{g\circ f}=\abs{g}\circ\abs{f}$$
\end{lmm}
...
Let $T_1,T_2$ be sets. Let $S_1,S_2$ be simplicial complexes on $T_1$ and $T_2$ respectively. Let $f:\abs{S_1}_{\phi_1}\to\abs{S_2}_{\phi_2}$ be a continuous map. A simplicial approximation of $f$ is a simplicial map $F:T_1\to T_2$ such that $\abs{F}$ is homotopic to $f$. 
\end{defn}

\begin{thm}{The Simplicial Approximation Theorem}{}\\
Let $T_1,T_2$ be sets. Let $S_1,S_2$ be simplicial complexes on $T_1$ and $T_2$ respectively. Let $f:\abs{S_1}\to\abs{S_2}$ be a continuous map. Then there exists $n\in\N^+$ and a simplicial approximation $F:\text{Bd}^n(S_1)\to S_2$ of $f$. 
\end{thm}
...
Triangulations may not exists in general, and they may not be unique. 

\subsection{Piecewise Linear Maps}
\begin{defn}{Piecewise Linear Maps}{}\\
Let $T_1,T_2$ be sets. Let $S_1,S_2$ be simplicial complexes on $T_1$ and $T_2$ respectively. Let $f:S_1\to S_2$ be a function. We say that $f$ is piecewise linear if there exists a subcomplex $S_1'\subseteq S_1$ such that $f|_{S_1'}$ is simplicial. 
\end{defn}

Clearly every simplicial map is piecewise linear. 
