...
\begin{thm}{The Fundamental Group}{} Let $X$ be a space and let $x\in X$. The set of all closed paths (loops) based at $x$ form a group $$\pi_1(X,x)=\left\{[f]\;\bigg{|}\;f:I\to X\text{ is a loop}\right\}$$ with the rule $$[f]\cdot[g]=[f\cdot g]$$ for equivalent classes of loops $[f]$ and $[g]$. 
\begin{proof}
