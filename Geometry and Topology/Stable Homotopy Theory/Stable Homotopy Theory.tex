...
$\Omega^\infty X$ is an infinite loopspace. $\Omega^\infty$ induces an equivalence of homotopy categories between $\Omega$-spectra and infinite loopspaces. 
...
\begin{prp}{}{}\\
Let $X$ be a spectrum. Then there is a natural isomorphism $$\pi_n(X)\cong\pi_n(Q^\infty X)$$ for all $n\in\N$. 
\end{prp}
