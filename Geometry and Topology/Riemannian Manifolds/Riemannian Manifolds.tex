...
\subsection{Lengths, Angles and Volumes}
...
\begin{defn}{}{}\\
Let $(M,g)$ be an orientable Riemannian manifold. Let $p\in M$. Let $(U,x^1,\dots,x^n)$ be a chart around $p$. Define the volume form $\text{Vol}(M)$ of $M$ to be given locally on the chart by $$\text{Vol}_p=\sqrt{\abs{g_p}}dx^1|_p\wedge\cdots\wedge dx^n|_p$$
\end{defn}
