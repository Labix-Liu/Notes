...
\section{Applications of the Homotopy Lifting Property}
...
\subsection{Holomorphic nth Root and Logarithms}
\begin{thm}{Holomorphic nth Root}{}\\
Let $\Omega\subseteq\C$ be an open and connected subset. Let $f:\Omega\to\C$ be a meromorphic function that is not identically $0$. Let $n\in\N$. Then there exists a holomorphic function $g:\Omega\to\C$ such that $g^n=f$ if and only if $$\frac{1}{2\pi i}\int_\gamma\frac{f'(z)}{f(z)}\;dz\in n\Z$$ for all contours $\gamma:U\to\C$. 
\end{thm}

\begin{thm}{Holomorphic Logarithms}{}\\
Let $\Omega\subseteq\C$ be an open and connected subset. Let $f:\Omega\to\C$ be a meromorphic function that is not identically $0$. Let $n\in\N$. Then there exists a holomorphic function $g:\Omega\to\C$ such that $f=e^g$ if and only if $$\frac{1}{2\pi i}\int_\gamma\frac{f'(z)}{f(z)}\;dz=0$$ for all contours $\gamma:U\to\C$. 
\end{thm}
...
\begin{thm}{Riemann Mapping Theorem}{} Let $\Omega\subset\C$ be any simply connected domain strictly smaller than $\C$. Then $\Omega$ is conformally equivalent to the unit disk $D$. 
\begin{proof}
