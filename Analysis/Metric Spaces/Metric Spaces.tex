...
\item For every open subset $V\subseteq Y$, we have $f^{-1}(U)\subseteq X$ is open. 
\end{itemize}
\begin{proof}
\end{proof}
\end{prp}
...
\begin{prp}{}{}\\
Let $X,Y$ be metric spaces. Let $f:X\to Y$ be a function. Then $f$ is continuous if and only if for every open subset $V\subseteq Y$, we have $f^{-1}(U)\subseteq X$ is open. 
\begin{proof}\\
