...
\newcommand{\TheAuthor}{Labix Liu}
\newcommand{\TheTitle}{Excisive Functors}
...
\newcommand{\TheSubDate}{\monthyear \formatdate{31}{3}{2025}}
...
\newtheorem{conjecture}[prp]{Conjecture}
