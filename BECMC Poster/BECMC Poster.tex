...
\usebackgroundtemplate{%
  \begin{tikzpicture}[remember picture, overlay]
    ...
    % ===== Scattered triangles (polytopes) =====
    \foreach \x/\y/\rot/\scl in {8/72/15/2.4, 38/78/70/2.8, 95/74/40/2.0, 18/8/10/2.2, 55/10/55/2.6, 88/12/130/1.8, 5/42/85/2.0, 105/45/20/2.2, 70/55/100/1.8, 25/30/60/2.0} {
      \draw[gray!10, fill=gray!6, rotate around={\rot:(\x,\y)}]
        (\x,\y) -- (\x+1.5*\scl,\y+0.4*\scl) -- (\x+0.6*\scl,\y+1.8*\scl) -- cycle;
    }
    % ===== Scattered quadrilaterals (simple polytopes) =====
    \foreach \x/\y/\rot/\scl in {45/45/25/2.2, 78/30/60/2.4, 12/58/15/2.0, 100/62/35/1.9} {
      \draw[gray!10, fill=gray!6, rotate around={\rot:(\x,\y)}]
        (\x,\y) -- (\x+2*\scl,\y) -- (\x+2.3*\scl,\y+1.6*\scl) -- (\x+0.3*\scl,\y+1.8*\scl) -- cycle;
    }
    % ===== Scattered regular pentagons =====
    \foreach \x/\y/\scl in {15/55/2.0, 90/68/1.8, 50/15/2.2, 112/35/1.6, 65/72/1.7} {
      \node[regular polygon, regular polygon sides=5, draw=gray!10,
            fill=gray!6, minimum size=\scl cm, rotate=18] at (\x,\y) {};
    }
    % ===== Simplicial complex meshes (triangulated patches) =====
    \begin{scope}[shift={(4,4)}]
      \foreach \i in {0,...,6} {
        \foreach \j in {0,...,2} {
          \draw[gray!10] (\i*1.8,\j*1.6) -- (\i*1.8+1.8,\j*1.6) -- (\i*1.8+0.9,\j*1.6+1.4) -- cycle;
        }
      }
    \end{scope}
    \begin{scope}[shift={(82,4)}]
      \foreach \i in {0,...,5} {
        \foreach \j in {0,...,2} {
          \draw[gray!10] (\i*1.8,\j*1.6) -- (\i*1.8+1.8,\j*1.6) -- (\i*1.8+0.9,\j*1.6+1.4) -- cycle;
        }
